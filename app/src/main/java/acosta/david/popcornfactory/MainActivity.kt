package acosta.david.popcornfactory
...
class MainActivity : AppCompatActivity() {
    ...
    var adapter2: PeliculaAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter2 = PeliculaAdapter(this, series)

        var gView = findViewById(R.id.gridviewMovies) as GridView
        var gView2 = findViewById(R.id.gridviewSeries) as GridView
        gView.adapter = adapter
        gView2.adapter = adapter2
